...
main(int argc, char *argv[])
{
  ...
  3d:	ff 33                	push   (%ebx)
  3f:	e8 bf 03 00 00       	call   403 <unlink>
...
gets(char *buf, int max)
{
 ...
 1a6:	83 ec 34             	sub    $0x34,%esp
  count++;
 1a9:	8b 15 90 0b 00 00    	mov    0xb90,%edx
 1af:	8d 72 01             	lea    0x1(%edx),%esi
 1b2:	89 55 d4             	mov    %edx,-0x2c(%ebp)
 1b5:	89 35 90 0b 00 00    	mov    %esi,0xb90
  int i=0, cc, temp = count;
  char c;

  int fd = open("input.txt", O_RDONLY);
 1bb:	6a 00                	push   $0x0
 1bd:	68 65 08 00 00       	push   $0x865
...
free(void *ap)
{
 ...
 6c1:	a1 94 0b 00 00       	mov    0xb94,%eax
{
 ...
 6ff:	5b                   	pop    %ebx
  freep = p;
 700:	a3 94 0b 00 00       	mov    %eax,0xb94
}
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
 707:	5d                   	pop    %ebp
 ...
 716:	72 ce                	jb     6e6 <free+0x26>
{
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 94 0b 00 00       	mov    %eax,0xb94
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 94 0b 00 00    	mov    0xb94,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79b:	3b 05 94 0b 00 00    	cmp    0xb94,%eax
 ...
 7be:	e8 fd fe ff ff       	call   6c0 <free>
  return freep;
 7c3:	8b 15 94 0b 00 00    	mov    0xb94,%edx
 ...
 7ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 94 0b 00 00    	mov    %edx,0xb94
}
 ...
 7ff:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 94 0b 00 00 98 	movl   $0xb98,0xb94
 807:	0b 00 00 
    base.s.size = 0;
 80a:	b8 98 0b 00 00       	mov    $0xb98,%eax
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 98 0b 00 00 98 	movl   $0xb98,0xb98
 816:	0b 00 00 
    base.s.size = 0;
 819:	c7 05 9c 0b 00 00 00 	movl   $0x0,0xb9c
 820:	00 00 00 
    if(p->s.size >= nunits){
