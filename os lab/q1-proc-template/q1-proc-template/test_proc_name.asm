...
_test_proc_name:     file format elf32-i386
...
int main()
{
   ...
   3:	83 e4 f0             	and    $0xfffffff0,%esp
    test_proc_name();
   6:	e8 05 00 00 00       	call   10 <test_proc_name>
    exit();
   b:	e8 43 04 00 00       	call   453 <exit>

00000010 <test_proc_name>:
void test_proc_name(){
  10:	55                   	push   %ebp
  ...
  15:	83 ec 10             	sub    $0x10,%esp
    int pid = getpid(); 
  18:	e8 b6 04 00 00       	call   4d3 <getpid>
    char* buf = malloc(16);
  ...
  22:	89 c3                	mov    %eax,%ebx
    char* buf = malloc(16);
  24:	e8 c7 07 00 00       	call   7f0 <malloc>
    if (buf == 0) {
  29:	83 c4 10             	add    $0x10,%esp
  2c:	85 c0                	test   %eax,%eax
  2e:	0f 84 d2 00 00 00    	je     106 <test_proc_name+0xf6>
    int fill_status1 = fill_proc_name(pid, buf);
  34:	83 ec 08             	sub    $0x8,%esp
    if (get_proc_name(pid, name, sizeof(name)) > 0)
  37:	8d 75 e8             	lea    -0x18(%ebp),%esi
    int fill_status1 = fill_proc_name(pid, buf);
  3a:	68 f2 08 00 00       	push   $0x8f2
  3f:	53                   	push   %ebx
  40:	e8 be 04 00 00       	call   503 <fill_proc_name>
    printf(1, "%d", fill_status1);
  45:	83 c4 0c             	add    $0xc,%esp
  48:	50                   	push   %eax
  49:	68 fd 08 00 00       	push   $0x8fd
  4e:	6a 01                	push   $0x1
  50:	e8 7b 05 00 00       	call   5d0 <printf>
    int fill_status2 = fill_proc_name(10000, buf);
  55:	58                   	pop    %eax
  56:	5a                   	pop    %edx
  57:	68 f2 08 00 00       	push   $0x8f2
  5c:	68 10 27 00 00       	push   $0x2710
  61:	e8 9d 04 00 00       	call   503 <fill_proc_name>
    printf(1, "%d", fill_status2);
  66:	83 c4 0c             	add    $0xc,%esp
  69:	50                   	push   %eax
  6a:	68 fd 08 00 00       	push   $0x8fd
  6f:	6a 01                	push   $0x1
  71:	e8 5a 05 00 00       	call   5d0 <printf>
    if (get_proc_name(pid, name, sizeof(name)) > 0)
  76:	83 c4 0c             	add    $0xc,%esp
  79:	6a 10                	push   $0x10
  7b:	56                   	push   %esi
  7c:	53                   	push   %ebx
  7d:	e8 89 04 00 00       	call   50b <get_proc_name>
  82:	83 c4 10             	add    $0x10,%esp
  85:	85 c0                	test   %eax,%eax
  87:	7e 47                	jle    d0 <test_proc_name+0xc0>
    printf(1, "Process with pid (%d) has name: %s\n",pid, name);
  89:	56                   	push   %esi
  8a:	53                   	push   %ebx
  8b:	68 2c 09 00 00       	push   $0x92c
  90:	6a 01                	push   $0x1
  ...
  9d:	6a 10                	push   $0x10
  9f:	56                   	push   %esi
  a0:	68 10 27 00 00       	push   $0x2710
  a5:	e8 61 04 00 00       	call   50b <get_proc_name>
  aa:	83 c4 10             	add    $0x10,%esp
  ad:	85 c0                	test   %eax,%eax
  af:	7e 37                	jle    e8 <test_proc_name+0xd8>
    printf(1, "Process with pid (%d) has name: %s\n",10000, name);
  b1:	56                   	push   %esi
  b2:	68 10 27 00 00       	push   $0x2710
  b7:	68 2c 09 00 00       	push   $0x92c
  bc:	6a 01                	push   $0x1
  ...
  d3:	68 00 09 00 00       	push   $0x900
  d8:	6a 01                	push   $0x1
  da:	e8 f1 04 00 00       	call   5d0 <printf>
  df:	83 c4 10             	add    $0x10,%esp
  e2:	eb b6                	jmp    9a <test_proc_name+0x8a>
  e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    printf(1, "Process with pid (%d) was not found\n", 10000);
  e8:	83 ec 04             	sub    $0x4,%esp
  eb:	68 10 27 00 00       	push   $0x2710
  f0:	68 50 09 00 00       	push   $0x950
  f5:	6a 01                	push   $0x1
  f7:	e8 d4 04 00 00       	call   5d0 <printf>
 ...
 10f:	e8 bc 04 00 00       	call   5d0 <printf>
        exit();
 114:	e8 3a 03 00 00       	call   453 <exit>
...
gets(char *buf, int max)
{
 ...
 246:	83 ec 34             	sub    $0x34,%esp
  count++;
 249:	8b 15 ac 0c 00 00    	mov    0xcac,%edx
 24f:	8d 72 01             	lea    0x1(%edx),%esi
 252:	89 55 d4             	mov    %edx,-0x2c(%ebp)
 255:	89 35 ac 0c 00 00    	mov    %esi,0xcac
  int i=0, cc, temp = count;
  char c;

  int fd = open("input.txt", O_RDONLY);
 25b:	6a 00                	push   $0x0
 25d:	68 13 09 00 00       	push   $0x913
 ...
 538:	89 d1                	mov    %edx,%ecx
{
 ...
 56b:	0f b6 92 d0 09 00 00 	movzbl 0x9d0(%edx),%edx
 ...
 5d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 644:	ff 24 85 78 09 00 00 	jmp    *0x978(,%eax,4)
 ...
 750:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 755:	bb 23 09 00 00       	mov    $0x923,%ebx
...
free(void *ap)
{
 ...
 761:	a1 b0 0c 00 00       	mov    0xcb0,%eax
{
 ...
 79f:	5b                   	pop    %ebx
  freep = p;
 7a0:	a3 b0 0c 00 00       	mov    %eax,0xcb0
}
 7a5:	5e                   	pop    %esi
 7a6:	5f                   	pop    %edi
 7a7:	5d                   	pop    %ebp
 ...
 7b6:	72 ce                	jb     786 <free+0x26>
{
 ...
 7d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7da:	a3 b0 0c 00 00       	mov    %eax,0xcb0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7fc:	8b 15 b0 0c 00 00    	mov    0xcb0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 83b:	3b 05 b0 0c 00 00    	cmp    0xcb0,%eax
 ...
 85e:	e8 fd fe ff ff       	call   760 <free>
  return freep;
 863:	8b 15 b0 0c 00 00    	mov    0xcb0,%edx
 ...
 88c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 88f:	89 15 b0 0c 00 00    	mov    %edx,0xcb0
}
 ...
 8a7:	0c 00 00 
    base.s.size = 0;
 8aa:	b8 b4 0c 00 00       	mov    $0xcb4,%eax
    base.s.ptr = freep = prevp = &base;
 8af:	c7 05 b4 0c 00 00 b4 	movl   $0xcb4,0xcb4
 8b6:	0c 00 00 
    base.s.size = 0;
