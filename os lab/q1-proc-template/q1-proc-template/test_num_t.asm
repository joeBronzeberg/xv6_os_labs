...
_test_num_t:     file format elf32-i386
...
int main()
{
   ...
   6:	e8 05 00 00 00       	call   10 <test_get_num_timer_interrupts>
    exit();
   b:	e8 a3 03 00 00       	call   3b3 <exit>

00000010 <test_get_num_timer_interrupts>:
void test_get_num_timer_interrupts(){
  ...
  14:	83 ec 04             	sub    $0x4,%esp
    int pid = getpid();
  17:	e8 17 04 00 00       	call   433 <getpid>
    printf(1, "%d\n", get_num_timer_interrupts(pid));
  ...
  20:	89 c3                	mov    %eax,%ebx
    printf(1, "%d\n", get_num_timer_interrupts(pid));
  22:	e8 54 04 00 00       	call   47b <get_num_timer_interrupts>
  ...
  40:	d8 05 54 08 00 00    	fadds  0x854
  46:	d9 05 58 08 00 00    	flds   0x858
  4c:	df f1                	fcomip %st(1),%st
  4e:	77 f0                	ja     40 <test_get_num_timer_interrupts+0x30>
  50:	dd d8                	fstp   %st(0)
    sleep(1);
  52:	83 ec 0c             	sub    $0xc,%esp
  55:	6a 01                	push   $0x1
  57:	e8 e7 03 00 00       	call   443 <sleep>
    printf(1, "%d\n", get_num_timer_interrupts(pid));
  5c:	89 1c 24             	mov    %ebx,(%esp)
  5f:	e8 17 04 00 00       	call   47b <get_num_timer_interrupts>
  64:	83 c4 0c             	add    $0xc,%esp
  67:	50                   	push   %eax
  68:	68 38 08 00 00       	push   $0x838
  6d:	6a 01                	push   $0x1
...
gets(char *buf, int max)
{
 ...
 1a6:	83 ec 34             	sub    $0x34,%esp
  count++;
 1a9:	8b 15 7c 0b 00 00    	mov    0xb7c,%edx
 1af:	8d 72 01             	lea    0x1(%edx),%esi
 1b2:	89 55 d4             	mov    %edx,-0x2c(%ebp)
 1b5:	89 35 7c 0b 00 00    	mov    %esi,0xb7c
  int i=0, cc, temp = count;
  char c;

  int fd = open("input.txt", O_RDONLY);
 1bb:	6a 00                	push   $0x0
 1bd:	68 3c 08 00 00       	push   $0x83c
 ...
 498:	89 d1                	mov    %edx,%ecx
{
 ...
 4cb:	0f b6 92 b4 08 00 00 	movzbl 0x8b4(%edx),%edx
 ...
 539:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5a4:	ff 24 85 5c 08 00 00 	jmp    *0x85c(,%eax,4)
 ...
 6b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 6b5:	bb 4c 08 00 00       	mov    $0x84c,%ebx
 ...
 6c1:	a1 80 0b 00 00       	mov    0xb80,%eax
{
 ...
 6ff:	5b                   	pop    %ebx
  freep = p;
 700:	a3 80 0b 00 00       	mov    %eax,0xb80
}
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
 707:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 79b:	3b 05 80 0b 00 00    	cmp    0xb80,%eax
 ...
 7be:	e8 fd fe ff ff       	call   6c0 <free>
  return freep;
 7c3:	8b 15 80 0b 00 00    	mov    0xb80,%edx
 ...
 7ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 80 0b 00 00    	mov    %edx,0xb80
}
 ...
 7ff:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 80 0b 00 00 84 	movl   $0xb84,0xb80
 807:	0b 00 00 
    base.s.size = 0;
 80a:	b8 84 0b 00 00       	mov    $0xb84,%eax
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 84 0b 00 00 84 	movl   $0xb84,0xb84
 816:	0b 00 00 
    base.s.size = 0;
 819:	c7 05 88 0b 00 00 00 	movl   $0x0,0xb88
 820:	00 00 00 
    if(p->s.size >= nunits){
