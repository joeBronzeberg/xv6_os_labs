...
main(int argc, char **argv)
{
  ...
  2e:	83 c3 01             	add    $0x1,%ebx
    kill(atoi(argv[i]));
  31:	e8 ea 02 00 00       	call   320 <atoi>
  36:	89 04 24             	mov    %eax,(%esp)
  39:	e8 85 03 00 00       	call   3c3 <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 49 03 00 00       	call   393 <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  4c:	68 18 08 00 00       	push   $0x818
  51:	6a 02                	push   $0x2
  53:	e8 b8 04 00 00       	call   510 <printf>
    exit();
  58:	e8 36 03 00 00       	call   393 <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
...
gets(char *buf, int max)
{
 ...
 186:	83 ec 34             	sub    $0x34,%esp
  count++;
 189:	8b 15 58 0b 00 00    	mov    0xb58,%edx
 18f:	8d 72 01             	lea    0x1(%edx),%esi
 192:	89 55 d4             	mov    %edx,-0x2c(%ebp)
 195:	89 35 58 0b 00 00    	mov    %esi,0xb58
  int i=0, cc, temp = count;
  char c;

  int fd = open("input.txt", O_RDONLY);
 19b:	6a 00                	push   $0x0
 19d:	68 2c 08 00 00       	push   $0x82c
 ...
 478:	89 d1                	mov    %edx,%ecx
{
 ...
 4ab:	0f b6 92 9c 08 00 00 	movzbl 0x89c(%edx),%edx
 ...
 519:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 584:	ff 24 85 44 08 00 00 	jmp    *0x844(,%eax,4)
 ...
 690:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 695:	bb 3c 08 00 00       	mov    $0x83c,%ebx
...
free(void *ap)
{
 ...
 6a1:	a1 5c 0b 00 00       	mov    0xb5c,%eax
{
 ...
 6df:	5b                   	pop    %ebx
  freep = p;
 6e0:	a3 5c 0b 00 00       	mov    %eax,0xb5c
}
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 6e7:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 5c 0b 00 00    	mov    0xb5c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77b:	3b 05 5c 0b 00 00    	cmp    0xb5c,%eax
 ...
 79e:	e8 fd fe ff ff       	call   6a0 <free>
  return freep;
 7a3:	8b 15 5c 0b 00 00    	mov    0xb5c,%edx
 ...
 7cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 5c 0b 00 00    	mov    %edx,0xb5c
}
 ...
 7df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 5c 0b 00 00 60 	movl   $0xb60,0xb5c
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	b8 60 0b 00 00       	mov    $0xb60,%eax
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 60 0b 00 00 60 	movl   $0xb60,0xb60
 7f6:	0b 00 00 
    base.s.size = 0;
 7f9:	c7 05 64 0b 00 00 00 	movl   $0x0,0xb64
 800:	00 00 00 
    if(p->s.size >= nunits){
